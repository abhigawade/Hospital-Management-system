...
<section id="main-content">
      ...
      <div class="row">
  <div class="col-lg-12">
    <h3 class="page-header"><i class="fa fa-file-text-o"></i><b> DELETE APPOINTMENTS </b></h3>
              ...
              <table class="table datatable table-advance table-hover">
               ...
               ?>
                ...
                <tr>
                    ...
                    <td>
                      <a href='../source/deleteappointmentdoctorsource.php?id=<?php echo $row['id'];?>'><input type="submit" value="Delete" class="delete"></a>
                    </td>
